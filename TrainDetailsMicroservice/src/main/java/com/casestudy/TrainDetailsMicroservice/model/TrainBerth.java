...
public class TrainBerth {
	...
	public TrainBerth( long trainNumber, String trainName, String trainSourcePlace, String trainDestinationPlace,
			LocalDateTime depatureDateTime, LocalDateTime arrivalDateTime, String trainDuration, int kilometers,
			String coach, String isAvailable, double pricePerTicket) {
		super();
